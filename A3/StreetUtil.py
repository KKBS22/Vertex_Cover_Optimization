...
def intersectAtLines_V2(streetLineA,streetLineB):
    doesIntersect = False
    x1, y1 = streetLineA[0][0], streetLineA[0][1]
    x2, y2 = streetLineA[1][0], streetLineA[1][1]
    x3, y3 = streetLineB[0][0], streetLineB[0][1]
    x4, y4 = streetLineB[1][0], streetLineB[1][1]
    ...
    return xcoor, ycoor,doesIntersect
